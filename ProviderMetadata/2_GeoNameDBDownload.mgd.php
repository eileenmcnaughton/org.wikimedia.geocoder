...
return [
  [
    ...
    'entity' => 'Geocoder',
    'help_text' => ts('Additional config is required to set this up - you need to get a data set from http://download.geonames.org/export/zip/ & import it into your civicrm DB. Default table name is civicrm_geonames_lookup'),
    'params' => [
      'version' => 3,
      'name' => 'geonames_db_table',
